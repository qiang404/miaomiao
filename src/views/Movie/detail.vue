  ...
  <div id="detailContainer" class="slide-enter-active">
    ...
    <div v-else id="content" class="contentDetail">
      <div class="detail_list">
        <div class="detail_list_bg" :style="{'background-image':'url('+movieInfo.img.replace(/w.h/,'148.200')+')'}"></div>
...
<style scoped>
#detailContainer{position: absolute;left: 0;top:0;z-index: 15;width:100%;height: 100%;min-height: 100%;background-color: #fff;}
#detailContainer.slide-enter-active{animation: .3s slideMove}
@keyframes slideMove{
    0%{transform: translateX(100%);}
    100%{transform: translateX(0)}
}
#content.contentDetail{ display: block; margin-bottom:0;overflow: hidden;}
